...
public class NomeUsoDTO {
    ...
    public static NomeUsoDTO fromJson(final String json) {
        final Gson gson = GSON_BUILDER.create();
        return gson.fromJson(json, NomeUsoDTO.class);
    }
    ...
    public static NomeUsoDTO fromXml(final String xml) throws JAXBException {
        final JAXBContext context = JAXBContext.newInstance(NomeUsoDTO.class);
        final Unmarshaller unm = context.createUnmarshaller();
        final StringReader sr = new StringReader(xml);
        return (NomeUsoDTO) unm.unmarshal(sr);
    }
