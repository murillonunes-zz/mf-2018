...
public class TituloEleitoralDTO {
    ...
    public static TituloEleitoralDTO fromXml(final String xml) throws JAXBException {
        final JAXBContext context = JAXBContext.newInstance(TituloEleitoralDTO.class);
        final Unmarshaller unm = context.createUnmarshaller();
        final StringReader sr = new StringReader(xml);
        return (TituloEleitoralDTO) unm.unmarshal(sr);
    }
