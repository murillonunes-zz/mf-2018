...
public class RacaDTO {
    ...
    public static RacaDTO fromJson(final String json) {
        final Gson gson = GSON_BUILDER.create();
        return gson.fromJson(json, RacaDTO.class);
    }
    ...
    public static RacaDTO fromXml(final String xml) throws JAXBException {
        final JAXBContext context = JAXBContext.newInstance(RacaDTO.class);
        final Unmarshaller unm = context.createUnmarshaller();
        final StringReader sr = new StringReader(xml);
        return (RacaDTO) unm.unmarshal(sr);
    }
