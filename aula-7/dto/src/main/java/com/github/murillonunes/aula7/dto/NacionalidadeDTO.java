...
public class NacionalidadeDTO {
    ...
    public static NacionalidadeDTO fromXml(final String xml) throws JAXBException {
        final JAXBContext context = JAXBContext.newInstance(NacionalidadeDTO.class);
        final Unmarshaller unm = context.createUnmarshaller();
        final StringReader sr = new StringReader(xml);
        return (NacionalidadeDTO) unm.unmarshal(sr);
    }
