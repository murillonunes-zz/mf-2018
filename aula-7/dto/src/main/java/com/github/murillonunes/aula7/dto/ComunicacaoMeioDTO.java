 ...
 * @version 1.0
 */
@XmlRootElement(name = "comunicacaoMeio")
public class ComunicacaoMeioDTO {
    ...
    public static ComunicacaoMeioDTO fromJson(final String json) {
        final Gson gson = GSON_BUILDER.create();
        return gson.fromJson(json, ComunicacaoMeioDTO.class);
    }
    ...
    public static ComunicacaoMeioDTO fromXml(final String xml) throws JAXBException {
        final JAXBContext context = JAXBContext.newInstance(ComunicacaoMeioDTO.class);
        final Unmarshaller unm = context.createUnmarshaller();
        final StringReader sr = new StringReader(xml);
        return (ComunicacaoMeioDTO) unm.unmarshal(sr);
    }
